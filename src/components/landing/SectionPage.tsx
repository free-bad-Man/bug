  ...
  return (
    <SiteShell background={page.background}>
      ...
      <Section
        id="lead"
        eyebrow="Расчёт"
        title="Подготовить вводные для расчёта"
        text="Укажите город, тип объекта, площадь, зоны риска, формат работ и срочность. По этим параметрам подбирается режим обработки, график визитов и состав документов."
      >
        <LeadForm />
      </Section>
    </SiteShell>
