...
export default function Page() {
  return (
    <SiteShell background={home.background}>
      ...
      <Section
        eyebrow="Актуализация"
        title="Контактные данные и реквизиты"
        text="Контактные каналы, реквизиты и дополнительные сведения будут уточняться и обновляться по мере утверждения рабочих каналов связи компании."
      />
    </SiteShell>
  );
}